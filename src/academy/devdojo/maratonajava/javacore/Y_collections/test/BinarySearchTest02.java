...
public class BinarySearchTest02 {
    public static void main(String[] args) {
        ...
        ProgrammingLanguage languageToSearch = new ProgrammingLanguage(06L,"Java",18);

        System.out.println(Collections.binarySearch(programmingLanguages, languageToSearch));
    }
}
